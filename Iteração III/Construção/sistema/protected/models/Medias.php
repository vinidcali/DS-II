 ...
 */
class Medias extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('aluno_id, etapa_id', 'required'),
			array('aluno_id, etapa_id', 'numerical', 'integerOnly'=>true),
			array('media', 'numerical'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, media, aluno_id, etapa_id', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return Medias the static model class
	 */
