...
class Aula extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('dataHora, cal_id', 'required'),
			array('cal_id', 'numerical', 'integerOnly'=>true),
			array('conteudo', 'length', 'max'=>1000),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, conteudo, dataHora, cal_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'cal' => array(self::BELONGS_TO, 'Calendario', 'cal_id'),
		);
	}
